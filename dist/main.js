...
const renderDetails = (data) => {
  ...
  const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.time), 'dd MMMM');
...
const renderCurrent = (data) => {
  ...
  const conditionValues = [
    ...
    (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.time), 'HH:mm'),
  ];
...
async function searchForCity(e) {
  ...
  if (e.code === 'Enter' && query.length > 0) {
    ...
    try {
      ...
      (0,_modules_display__WEBPACK_IMPORTED_MODULE_1__.renderDisplay)(weather);
    } catch (error) {
...
async function initialLoad() {
  const weather = await (0,_modules_data__WEBPACK_IMPORTED_MODULE_0__["default"])('hong kong');
  (0,_modules_display__WEBPACK_IMPORTED_MODULE_1__.renderDisplay)(weather);
}
